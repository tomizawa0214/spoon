...
class SignupUserForm(forms.Form):
    ...
    password1 = forms.CharField(widget=forms.PasswordInput(), min_length=6, label='パスワード')
    password2 = forms.CharField(widget=forms.PasswordInput(), min_length=6, label='パスワード（確認用）')
